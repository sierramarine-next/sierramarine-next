...
const filters = [
  ...
  { key: "basili-harita-seyir-yayinlari", label: "Basılı Harita & Seyir Yayınları" },
  { key: "survey-hazirligi", label: "Survey Hazırlığı" },
];

export default function HizmetlerPage() {
  const [activeFilter, setActiveFilter] = useState("all");
  const serviceList = services.tr;
    ...
    <div className="min-h-screen bg-white">
      <section className="relative bg-navy-900 text-white overflow-hidden">
        ...
        <div className="relative-z-2 mx-auto max-w-6xl px-4 py-20 text-center">
          <p className="text-sm uppercase tracking-wider text-gold-400 mb-2">HİZMETLER</p>
          <h1 className="text-4xl md:text-5xl font-bold">Hizmetler</h1>
          <p className="text-gray-200 max-w-2xl mx-auto mt-4">
            Sierra Marine olarak gemi donatım, emniyet ekipmanları, basılı ve dijital harita/yayınlar ile survey hazırlığı alanlarında uçtan uca çözümler sunuyoruz.
          </p>
        </div>
      </section>
